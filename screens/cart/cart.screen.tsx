...
//   const [cartItems, setCartItems] = useState<Program[]>([]);
...
//       // Créez un PaymentIntent pour chaque article du panier
...
//       // Utilisez le premier PaymentIntent pour initialiser la feuille de paiement
//       // (Stripe ne permet pas de payer plusieurs PaymentIntents en une seule fois)
//       const { client_secret: clientSecret } = paymentIntents[0];
...
//       } else {
//         await createSubscriptions(paymentResponse, paymentIntents);
//       }
//     } catch (error) {
//       console.error(error);
//     }
...
//   const createSubscriptions = async (paymentResponse: any, paymentIntents: any[]) => {
//     const accessToken = await AsyncStorage.getItem('access_token');
//     const refreshToken = await AsyncStorage.getItem('refresh_token');
...
//               paymentIntentId: paymentIntents[index].id,
//             },
//             {
//               headers: {
//                 'access-token': accessToken,
...
//                 }}
//               >
//                 <TouchableOpacity onPress={() => handleCourseDetails(item)}></TouchableOpacity>
