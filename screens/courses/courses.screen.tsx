...
//     } else {
//       const filterCourses = originalCourses.filter((i: CoursesType) => i.categories === e);
...
//               >
//                 <Text style={{ color: '#fff', fontSize: 18, fontWeight: '600' }}>All</Text>
//               </TouchableOpacity>
//               {categories?.map((i: any, index: number) => (
//                 <TouchableOpacity
//                   style={{
//                     padding: 10,
//                     backgroundColor: activeCategory === i?.title ? '#2467EC' : '#000',
//                     borderRadius: 50,
//                     paddingHorizontal: 20,
//                     marginHorizontal: 15,
//                   }}
